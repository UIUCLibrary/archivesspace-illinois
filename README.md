...
- Reconfigures "print_to_pdf_job" and "bulk_import_job" job types to permit concurrent execution based on the number of threads available to run background jobs (`AppConfig[:job_thread_count]`).
